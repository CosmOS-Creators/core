...
/********************************************************************************
  ...
  * @{    
********************************************************************************/
#define MAX_TASKS_ON_ONE_CORE                 (BitWidthType)3        /* Maximal number of configurated tasks on the one core  */

#define TASK_NUM_CORE_0                       (BitWidthType)3        /* Number of configurated tasks for the core M7_CORE */
#define TASK_NUM_CORE_1                       (BitWidthType)3        /* Number of configurated tasks for the core M4_CORE */
