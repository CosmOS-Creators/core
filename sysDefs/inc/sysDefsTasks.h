...
#define TASK_PROGRAM_0_CORE_0_NUM             (BitWidthType)1        /* Number of configurated tasks for the program default_CM7*/
#define TASK_PROGRAM_1_CORE_0_NUM             (BitWidthType)1        /* Number of configurated tasks for the program blinking_led_CM7*/
#define TASK_PROGRAM_0_CORE_1_NUM             (BitWidthType)1        /* Number of configurated tasks for the program default_CM4*/
