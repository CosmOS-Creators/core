...
#define SYNCTICKS_SCHEDULER_0                  (BitWidthType)50       /* SyncTicks for scheduler 0 in ticks */
...
#define SYNCTICKS_SCHEDULER_1                  (BitWidthType)50       /* SyncTicks for scheduler 1 in ticks */
