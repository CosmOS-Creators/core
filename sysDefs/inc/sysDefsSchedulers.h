...
#define SCHEDULER_CORE_0_ID                     (BitWidthType)0        /* Scheduler for core M7_CORE identificator     */
#define HYPERTICK_SCHEDULER_0                   (BitWidthType)100        /* HyperTick for scheduler 0 in ticks   */
#define LAST_TO_FIRST_TASK_TICK_SCHEDULER_0     (BitWidthType)50        /* Last to first task for scheduler 0 in ticks */
#define SYNCPERIOD_SCHEDULER_0                  (BitWidthType)0x00000000        /* Syncperiod for scheduler 0 in ticks */

#define SCHEDULER_CORE_1_ID                     (BitWidthType)1        /* Scheduler for core M4_CORE identificator     */
#define HYPERTICK_SCHEDULER_1                   (BitWidthType)100        /* HyperTick for scheduler 1 in ticks   */
#define LAST_TO_FIRST_TASK_TICK_SCHEDULER_1     (BitWidthType)50        /* Last to first task for scheduler 1 in ticks */
#define SYNCPERIOD_SCHEDULER_1                  (BitWidthType)0x00000000        /* Syncperiod for scheduler 1 in ticks */
/********************************************************************************
  * DOXYGEN STOP GROUP                                                         **
  * *************************************************************************//**
  * @}  
