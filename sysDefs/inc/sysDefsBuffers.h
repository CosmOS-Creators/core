...
/********************************************************************************
  ...
  * @{    
********************************************************************************/
#define BUFFER_NUM (BitWidthType)0x00000001     /* Number of initialized buffers */


#define BUFFER_0      (BitWidthType)0x00000000      /* Buffer id */
#define BUFFER_0_SIZE (BitWidthType)0x00000020      /* Buffer size */
#define BUFFER_XCORE_1_TO_0  BUFFER_0                      /* Buffer user name mapped to generated id */
/********************************************************************************
  * DOXYGEN STOP GROUP                                                         **
  * *************************************************************************//**
  * @}  
