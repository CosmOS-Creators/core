...
********************************************************************************/
    ...
    #define switchSchedulerSync_sync(coreVar,currentTick,syncPeriod) schedulerSync_sync(coreVar,currentTick,syncPeriod)
#else
    #define switchSchedulerSync_sync(coreVar,currentTick,syncPeriod) SCHEDULER_SYNC_STATE_ENUM__NOT_IN_SYNC
#endif
/********************************************************************************
  * DOXYGEN STOP GROUP                                                         **
  * *************************************************************************//**
