...
/********************************************************************************
  ...
  * @{                                                                           
********************************************************************************/
#define cosmosApi_deviceIO_togglePin(gpio,pin) sysCalls_readWrite(SYSCALL_DEVICEIO_TOGGLEPIN,gpio,pin)
#define cosmosApi_osInit_init() sysCalls_os(SYSCALL_OSINIT_INIT)
#define cosmosApi_os_start() sysCalls_os(SYSCALL_OS_START)
