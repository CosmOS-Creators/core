...
/**
  * @fn osBoot_boot(void)
  *
  * @brief OS boot function. This function is provided as a CosmOS API but can
...
/**
  ...
  *
  * @brief OS boot validation function. This function cannot be called from
  * the unprivileged context directly. This function should be called after the
  * boot of operating system and activation of MPU. DEMO
  *
  * @param[in]  none
  *
  * @return none
